...
class MQTTTelegrafMemoryDataSource (MQTTDataSource):
    ...
    def _parse(self, topic: str, message: str, timestamp: Optional[float] = None):
        ...
        #available_percent = self._extract_big_decimal(pattern = r"available_percent=([0-9]+\.[0-9]+)", message = message)
        ...
        used_percent = self._extract_big_decimal(pattern = r"used_percent=([0-9]+\.[0-9]+)", message = message)
