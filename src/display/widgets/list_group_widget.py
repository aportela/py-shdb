...
class ListGroupWidget(Widget):
    ...
    def __init__(self, name: str, x: int, y: int, width: int, height: int, padding: int, background_color: tuple[int, int, int] = None, border: bool = False, surface: pygame.Surface = None, title_font: WidgetFont = None, title_text: Optional[str] = None, items_font: WidgetFont = None, items_text: Optional[List[str]] = None) -> None:
